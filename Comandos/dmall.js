...
if (message.author.id !== '614607911339032698' && message.author.id !== '' && message.author.id !== '') return message.reply(":7775: | você não possui permissão para usar esse comando.");
message.delete()
